...
- 内置映射 48 条（内置命令 + 本仓库扩展 + Narumiruna 插件 + web-access/mcp-adapter）
- 二级/三级指令映射 96 条（goal/firecrawl/google-genai/chrome-devtools/sync/subagents/memory/conventions/switch、commandcode-* 等）
